    ...
    <div id="about">
      <div className="about-contant flex flex-col max-w-[1111px] mx-auto lg:flex-row justify-center  py-10 lg:py-24  text-white gap-20">
        <div className="about-information px-5 lg:w-[50%] lg:px-0  d">
          ...
          <h3 className="text-2xl py-7">
            Professional Full-Stack Web Developer & WordPress Specialis
          </h3>
          <p className="text-2xl">
            I’m Rabbani Sarkar Passionate at web development. I’m working
            minimum of 13-14 hours every day, I love to do this it’s my
            life-everything. My goal is to satisfy clients, try to understand
            what they want for there website, help them from beginning to end
            the project and give support for every problem. If need I
            communicate by video or audio conversations to understand the
          ...
          <div className="box-inner flex flex-col lg:flex-row  ">
            <Tilt className="box-one text-center roun bg-[#151030] p-6 m-4 rounded-lg border-2 border-[#4A00FF]">
              ...
              <p>
                ...
                100% quality & satisfaction before delivering the project.
              </p>
            </Tilt>
